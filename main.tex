...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Created monthly promotional videos reaching 5000+ viewers}
        \resumeItem{Produced high quality on set product photography}
    \resumeItemListEnd
...
\vspace{-5pt}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Worked with 3D development implementing humanoid kinematics}
...
\vspace{-5pt}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Created a website for 3000+ students at my high school to track service hours \\ using React and Firebase (ehs-service.org)}
        \resumeItem{Managed an open sourced community on GitHub}
    \resumeItemListEnd
  \resumeSubHeadingListEnd
\vspace{-5pt}
%-----------EDUCATION-----------
